			...
			<div class="row">
				<div class="col-lg-12 m-b30">
					<div class="widget-box">
                        ...
                        <form id ='filter' method = 'POST' action = 'financialManageProcess.php' onsubmit="return checkvalid();">
                            <div class = 'row'>
                        ...
                        $query2 = "SELECT DISTINCT fDate FROM fee ORDER BY fDate DESC";
                        ...
                        //             <td>
                        //             <form method = 'post' action = 'financialView.php'>
                        //             <input type = 'hidden' name = 'month' value = '$fDate' >
                        //             <input type = 'hidden' name = 'month' value = '$month' >
                        //             <input type = 'hidden' name = 'year' value = '$year' >
                        //             <input type = 'submit' class = 'btn red pull-left' value = 'View'></td>
                        //             </from>
