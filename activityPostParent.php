...
<div class="container-fluid">
    ...
    <div class="row">
            ...
            <div class='col-lg-12 m-b30'>
                ...
                <div class='widget-box '>
                    ...
                    <form id = "form-select" method = "post" action = "activityPostParent.php" >
                            ...
                            $query = "SELECT * FROM Student WHERE pIC = '$_SESSION[pIC]' ";
            ...
            $queryPost = "SELECT Activity.* FROM Activity JOIN Class ON Activity.clsName = Class.clsName WHERE Activity.clsName = '$_POST[clsName]' ORDER BY actID DESC";
